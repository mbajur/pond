module Views
  module Posts
    class Edit::Image < Views::Base
      ...
      def view_template
        form_with(model: @post, url: update_image_post_path(@post), method: :patch, id: :post_form, class: Components::Posts::ShowContent::CSS_CLASSES) do |f|
          render Views::Posts::Show::Image::Content.new(post: @post)
